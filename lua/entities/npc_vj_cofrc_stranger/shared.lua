ENT.Base 			= "npc_vj_cofr_stranger" -- List of all base types: https://github.com/DrVrej/VJ-Base/wiki/Base-Types
ENT.Type 			= "ai"
...
if CLIENT then
    function ENT:Initialize()
        local function GetStrangers()
            local strangers = {}
            for _,v in pairs(ents.FindByClass("npc_vj_cofrc_stranger")) do
                if IsValid(v) then
